...
with contextlib.suppress(ImportError):
    ...
    load_dotenv((Path(__file__).parent.parent.parent / '.env').resolve())


from infrastructure.database.config import create_db_config_from_env
...
config.set_section_option(section, "DB_DRIVER", db_config.driver)
